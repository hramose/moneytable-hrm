	...
	<div class="modal-header">
		...
		<h4 class="modal-title">{!! trans('messages.edit').' '.trans('messages.sub_task') !!}</h4>
	</div>
	<div class="modal-body">
		{!! Form::model($sub_task,['method' => 'PATCH','route' => ['sub-task.update',$sub_task] ,'class' => 'sub-task-edit-form','id' => 'sub-task-edit-form','data-table-alter' => 'user-shift-table']) !!}
